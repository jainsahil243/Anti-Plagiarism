...
import allcodes.algorithm.Algorithm;
...
public class AlgorithmTests {
    ...
    public void TwoIdenticalHelloWorlds() {
        String s1 = "package allcodes.app; public class Main { public static void main(String[] args) { System.out.println(\"Hello, world!\"); } }";
        String s2 = "package allcodes.app; public class Main { public static void main(String[] args) { System.out.println(\"Hello, world!\"); } }";
